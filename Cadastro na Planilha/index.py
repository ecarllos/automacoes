# Esse código tem a função de concertar os CNPJ's da planilha de relacionamento e alterar o consultor da empresa do SIstema
...
while True:
    ...
    pyautogui.hotkey("down","right","right","right","right") # Abaixar para ir para célula do código da empresa
    ...
    pyautogui.click(x=757, y=62) # Clicar no campo de pesquisa para confirmar que foi feito o (Ctrl + C)
